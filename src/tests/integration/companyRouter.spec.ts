...
describe('Company actions', () => {
  ...
  describe('Company Address Data Update', () => {
    it('Should return 200 OK when a company owner updates the address of an employee.', async () => {
      ...
      expect(res.body.address).to.have.keys('id', 'companyName', 'firstName', 'lastName', 'salutation', 'title', 'costCenter', 'email', 'country', 'city', 'street', 'zip', 'phone', 'addressAddition', 'affiliation', 'vat', 'type', 'createdAt', 'updatedAt')
    })
